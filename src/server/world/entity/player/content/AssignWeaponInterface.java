...
public class AssignWeaponInterface {
    ...
    static {
        ...
        for (ItemDefinition def : ItemDefinition.getDefinitions()) {
            ...
            if (def.getItemName().startsWith("Staff")
                    || def.getItemName().endsWith("staff")
                    || def.getItemName().endsWith("wands")) {
                ...
                weaponInterface[def.getItemId()] = WeaponInterface.WARHAMMER;
                    ...
                    || def.getItemName().endsWith("maul")
                    || def.getItemName().equals("Tzhaar-ket-om")) {
                weaponInterface[def.getItemId()] = WeaponInterface.WARHAMMER;
            } else if (def.getItemName().endsWith("battleaxe")) {
                weaponInterface[def.getItemId()] = WeaponInterface.BATTLEAXE;
            } else if (def.getItemName().equals("Crossbow")
                    || def.getItemName().endsWith("crossbow")) {
                weaponInterface[def.getItemId()] = WeaponInterface.CROSSBOW;
            } else if (def.getItemName().endsWith("shortbow")
                    || def.getItemName().startsWith("Crystal bow")
                    || def.getItemName().endsWith("crystal bow")) {
            ...
            } else if (def.getItemName().endsWith(" sword")
                ...
                weaponInterface[def.getItemId()] = WeaponInterface.MACE;
                    ...
                    || def.getItemName().endsWith("knife(p+)")
                    || def.getItemName().endsWith("knife(p++)")
                    || def.getItemName().equals("Toktz-xil-ul")) {
                ...
                weaponInterface[def.getItemId()] = WeaponInterface.HALBERD;
                    ...
                    || def.getItemName().endsWith("flail")) {
            ...
            } else if (def.getItemName().endsWith("axe")
    ...
    public enum FightType {
        ...
        SCIMITAR_SLASH(451, TrainType.STRENGTH, 43, 1, Misc.ATTACK_SLASH,
                FightStyle.AGGRESSIVE),
        SCIMITAR_LUNGE(412, TrainType.ATTACK_STRENGTH_DEFENCE, 43, 2,
                Misc.ATTACK_STAB, FightStyle.CONTROLLED),
        ...
        LONGSWORD_SLASH(451, TrainType.STRENGTH, 43, 1, Misc.ATTACK_SLASH,
                FightStyle.AGGRESSIVE),
        LONGSWORD_LUNGE(412, TrainType.ATTACK_STRENGTH_DEFENCE, 43, 2,
                Misc.ATTACK_STAB, FightStyle.CONTROLLED),
        ...
        MACE_PUMMEL(401, TrainType.STRENGTH, 43, 1, Misc.ATTACK_CRUSH,
                FightStyle.AGGRESSIVE),
        MACE_SPIKE(412, TrainType.ATTACK_STRENGTH_DEFENCE, 43, 2,
                Misc.ATTACK_STAB, FightStyle.CONTROLLED),
        ...
        KNIFE_RAPID(806, TrainType.RANGED, 43, 1, Misc.ATTACK_RANGE,
                FightStyle.AGGRESSIVE),
        KNIFE_LONGRANGE(806, TrainType.RANGED_DEFENCE, 43, 2,
                Misc.ATTACK_RANGE, FightStyle.DEFENSIVE),
        SPEAR_LUNGE(2080, TrainType.ATTACK_STRENGTH_DEFENCE, 43, 0,
                Misc.ATTACK_STAB, FightStyle.CONTROLLED),
        SPEAR_SWIPE(2081, TrainType.ATTACK_STRENGTH_DEFENCE, 43, 1,
                Misc.ATTACK_SLASH, FightStyle.CONTROLLED),
        SPEAR_POUND(2082, TrainType.ATTACK_STRENGTH_DEFENCE, 43, 2,
                Misc.ATTACK_CRUSH, FightStyle.CONTROLLED),
        ...
        CLAWS_SLASH(451, TrainType.STRENGTH, 43, 1, Misc.ATTACK_SLASH,
                FightStyle.AGGRESSIVE),
        CLAWS_LUNGE(412, TrainType.ATTACK_STRENGTH_DEFENCE, 43, 2,
                Misc.ATTACK_STAB, FightStyle.CONTROLLED),
        CLAWS_BLOCK(451, TrainType.DEFENCE, 43, 3, Misc.ATTACK_SLASH,
                FightStyle.DEFENSIVE),
        HALBERD_JAB(412, TrainType.ATTACK_STRENGTH_DEFENCE, 43, 0,
                Misc.ATTACK_STAB, FightStyle.CONTROLLED),
        ...
        WHIP_FLICK(1658, TrainType.ATTACK, 43, 0, Misc.ATTACK_SLASH,
                FightStyle.ACCURATE),
        WHIP_LASH(1658, TrainType.ATTACK_STRENGTH_DEFENCE, 43, 1,
                Misc.ATTACK_SLASH, FightStyle.CONTROLLED),
         ...
         *            the fighting style.
         */
        private FightType(int animation, TrainType trainType, int parentId,
    ...
    public static void assignSpecialBar(Player player) {
        ...
        for (SpecialWeapon weapon : player.getWeapon().getSpecialAttackItems()) {
            if (player.getEquipment().getContainer()
                    .getIdBySlot(Misc.EQUIPMENT_SLOT_WEAPON) == weapon
                    .getItemId()) {
                player.getPacketBuilder().sendHideInterfaceLayer(
