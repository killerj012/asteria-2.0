...
public enum FoodConsumable implements GenericAction<Player> {
	 ...
	 * 
	 * @see server.world.entity.content.consume.FoodConsumable#fireAction(server.world.entity.player.Player)
	 */
	@Override
     ...
     * @param ids The ids of this food type.
     */
	...
	boolean healed = food.fireAction(player);
	if (healed) {
