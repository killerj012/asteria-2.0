 ...
 * @author lare96
 */
public class PooledPlayerResetTask implements Runnable {
    ...
    /**
     * Create a new {@link PooledPlayerResetTask}.
     * 
     * @param player
     *        the {@link Player} we need to reset.
     * @param updateLatch
     ...
     */
    public PooledPlayerResetTask(Player player, CountDownLatch updateLatch) {
        this.player = player;
